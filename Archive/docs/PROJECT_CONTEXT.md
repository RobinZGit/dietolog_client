...
**Последнее обновление:** 2026-08-01 — v45: число как разделитель продуктов в быстром вводе
...
### 2026-08-01 (v45: число = разделитель продуктов)
- В поле быстрого ввода число после имени — **количество предыдущего** продукта; дальше начинается новый (`гречка 150 яйцо 100 молоко`).
- `,` / `;` / `.` по-прежнему разделяют продукты (в т.ч. без количества).
- Seed **v45**. USER #58. Сразу в master.
...
| Дата | Суть |
|------|------|
| 2026-08-01 | v45: number as product divider in quick layout input; USER #58 |
