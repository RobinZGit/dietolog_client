...
**Последнее обновление:** 2026-07-31 — скачать снимок раскладки (HTML)
...
### 2026-07-31 (скачать раскладку)
- В шапке «Анализ раскладки» справа кнопка **Скачать раскладку**.
- Файл HTML-снимок: продукты + таблица нутриентов в том же стиле (зелёный норма / розовый дефицит / рамка у калорий) + ссылка `items=` для повторного открытия. Живой UI не меняли по цветам.
- USER #44.
