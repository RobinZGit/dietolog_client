...
MODES_JS = ARCHIVE / "scripts" / "simple-get-modes.js"
...
CSS_EXTRA = """
    ...
    .yours-layout-block {
      ...
      border-radius: 10px;
      background: #f3f8f5;
      box-shadow: inset 0 0 0 1px color-mix(in srgb, #2f5d50 18%, transparent);
    }
    .yours-layout-head {
      display: flex; flex-wrap: wrap; align-items: center; gap: 0.65rem 1rem;
      margin: 0 0 0.55rem; justify-content: flex-start;
    }
    ...
    .yours-layout-block .layout-table th,
    .yours-layout-block .layout-table td {
      border-bottom: 1px solid #c9d7cf;
    }
    .yours-layout-block .layout-table tbody tr:last-child td {
      border-bottom: none;
    }
    ...
    .offline-bar {
      ...
      border: 1px solid #c5d9cc; border-radius: 8px; background: #eef7f1;
    }
    .btn-download {
      appearance: none; border: none; cursor: pointer;
      background: #2f5d50; color: #fff; font: inherit; font-weight: 700;
      font-size: 0.88rem; padding: 0.45rem 0.75rem; border-radius: 8px;
    }
    .btn-download:hover { background: #254a40; }
