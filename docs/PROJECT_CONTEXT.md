...
**Последнее обновление:** 2026-07-29 — v7: плоский список продуктов; группы только у БАД; без «Готовим базу»
...
| `products` | **1241** (в т.ч. 8 БАД) | id, name, fastdegree; `group` только у БАД |
