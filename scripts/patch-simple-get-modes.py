...
BODY_HEADER = """  <header>
    <h1>Р”РёРµС‚РѕР»РѕРі <span style="font-weight:500;color:var(--muted);font-size:0.75em">РїСЂРѕСЃС‚РѕР№</span> <span id="appVersion" class="ver">v10</span></h1>
    <p class="lead" id="leadText">РџРѕРёСЃРє в†’ <b>РіСЂСѓРїРїР°</b> в†’ РїСЂРѕРґСѓРєС‚ в†’ РЅСѓС‚СЂРёРµРЅС‚С‹. Р’СЃРµ Р‘РђР”С‹ РІ РѕРґРЅРѕР№ РіСЂСѓРїРїРµ <b>Р‘РђР”</b>.</p>
    <div class="toolbar" id="toolbar">
      <input id="q" type="search" placeholder="РџРѕРёСЃРє РїСЂРѕРґСѓРєС‚Р° РёР»Рё РіСЂСѓРїРїС‹вЂ¦" autocomplete="off" />
      <div id="status">Р—Р°РіСЂСѓР·РєР°вЂ¦</div>
    </div>
  </header>
  <div id="modePanel"></div>
  <p class="browse-title" id="browseTitle">РЎРїСЂР°РІРѕС‡РЅРёРє РїСЂРѕРґСѓРєС‚РѕРІ</p>
  <main>
    <div id="list" class="list"><div class="loading">Р—Р°РіСЂСѓР·РєР° РіСЂСѓРїРївЂ¦</div></div>
  </main>
"""
...
function setVersionLabel() {
  ...
  document.title = 'Р”РёРµС‚РѕР»РѕРі вЂ” РїСЂРѕСЃС‚РѕР№ ' + v + modeTag;
}
